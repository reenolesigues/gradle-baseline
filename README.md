...
**Add `com.palantir.baseline-format.palantir-java-format=true`** to your gradle.properties to run our fork of google-java-format. The Palantir Java Formatter can be run from IntelliJ using the [palantir-java-format](https://plugins.jetbrains.com/plugin/13180-palantir-java-format) plugin.
